...
Deve ser considerado que qualquer número elevado a zero é 1, elevado a 1
é ele próprio.A apresentação deve observar a seguinte exibição na tela:
...
while (cont <= 15):
    print(f"3 elevado à {cont} = {cont} é {3 ** cont}")
    cont = cont + 1